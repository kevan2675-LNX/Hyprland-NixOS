...
lib.mkIf (theShell == "bash") {
  ...
  programs.bash = {
    ...
    shellAliases = {
      ...
      lal="lsd -al";
      ".."="cd ..";
      hell="ssh lucifer@165.22.52.204 -i \${config.home.homeDirectory}/Projects/cloudNix/sshPrivKey.pem";
      ...
      burp="cd \${config.home.homeDirectory}/Projects/burpsuite_pro_v2022.9; java -jar burploader.jar";
      ...
      config="cd \${config.home.homeDirectory}/Hyprland-NixOS/";	
